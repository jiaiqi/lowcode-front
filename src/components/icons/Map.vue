<template>
  <svg :width="_width" :height="_height" :spin="spin" :rtl="rtl" viewBox="0 0 48 48" fill="none" role="presentation"
    ref="host" xmlns="http://www.w3.org/2000/svg">
    <path d="M17 12L4 6V36L17 42L31 36L44 42V12L31 6L17 12Z" fill="currentColor" stroke="currentColor" stroke-width="4"
